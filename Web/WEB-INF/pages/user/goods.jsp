        ...
        <div id="user_content">
            <div class="share">
                <!--
                    ...
                    描述：闲置商品展示
                -->
                <h1 style="text-align: center">My idles</h1>
					<hr />
                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <div class="box">
                                    ...
                                    <div class="interact">
                                        <span class="fa fa-edit fa-lg"><a href="<%=basePath%>goods/editGoods/${items.goods.id}">EDIT</a></span>
                                     ...
                                     <%--  <span class="fa fa-commenting"><a>${items.comments.commetNum}</a></span> --%>
                                        ...
                                        <span class="fa fa-trash fa-lg"><a href="<%=basePath%>goods/deleteGoods/${items.goods.id}">DELETE</a></span>
                                    </div><br>
