...
<%--                <a href="<%=basePath%>user/home">
            ...
            <div id="user_nav">
                <div class="user_info">
                    ...
                    <%--<a class="btn" style="width: 98%;background-color: rgb(79, 190, 246);color:rgba(255, 255, 255, 1);" href="<%=basePath%>user/myPurse" style="background-color: #e5b313">My Purse：￥${myPurse.balance}</a>
                    <input type="hidden" value="${myPurse.recharge}" id="recharge" />
                    <input type="hidden" value="${myPurse.withdrawals}" id="withdrawals" />
                    <span class="btn" data-toggle="modal" data-target="#myModal" style="background-color: #e5b313">My credit：${cur_user.power}</span>
--%>
                </div>
                <div class="home_nav">
                    <ul>
