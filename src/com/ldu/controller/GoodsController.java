...
public class GoodsController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/addComments", produces = "text/json;charset=UTF-8")
	@ResponseBody
	public void addComments(HttpServletRequest request, Comments comments, HttpServletResponse response) {
		User cur_user = (User)request.getSession().getAttribute("cur_user");
		comments.setUser(cur_user);
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
		Date createAt =new Date();
		comments.setCreateAt(simpleDateFormat.format(createAt));
		goodsService.addComments(comments);
		String data = "{\"success\": \"true\", \"msg\":\"New message added\"}";
		try {
	...
	public ModelAndView offGoods() throws Exception { return null; }
